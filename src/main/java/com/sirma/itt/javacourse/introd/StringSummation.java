...
/**
 * Class used to find the sum of two numbers presented as strings
 *
...
public class StringSummation {
	...
	public StringSummation(String first, String second) {
		this.firstNum = first;
	...
	/**
	 * Used to find the sum of the i-th digits of the two numbers
	 * 
	 * @param i
