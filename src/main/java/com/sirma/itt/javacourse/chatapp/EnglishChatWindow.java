...
/**
 * Implements the chat window for English users.
 * 
 * @author Ventsislav Marinov
 */
public class EnglishChatWindow extends JFrame implements ChatGUI, ActionListener, KeyListener {
	...
	public EnglishChatWindow(ClientLogic clientLogic) {
	...
	public void showMessageDialog(String reason) {
		if (reason == SERVER_CLOSING) {
			JOptionPane.showMessageDialog(this, "Server closed", "Server shut down",
